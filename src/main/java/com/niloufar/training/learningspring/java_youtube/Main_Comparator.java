...
public class Main_Comparator {
    ...
    public static void main(String [] args){
        Employee e1= new Employee(1,20,"Tom", 60000, new com.niloufar.training.learningspring.java_features.functional_interface.Address("Street1", 111));
        Employee e2= new Employee(2,19,"Hassan",65000, new com.niloufar.training.learningspring.java_features.functional_interface.Address("Street23", 222));
        Employee e3= new Employee(3,18,"Ali", 30000, new com.niloufar.training.learningspring.java_features.functional_interface.Address("Street34", 333));
        Employee e4= new Employee(4,17,"Mary", 40000, new com.niloufar.training.learningspring.java_features.functional_interface.Address("Street45", 444));
        ...
        Collections.sort(mylist,new AddressComparator());//we did inside it implement the natural sorting//will be sort base of addresses and then on address base on pinCode
        System.out.println("Sorted based on pincode in address : " + mylist);
        System.out.println("*************************************************************************");
